...
#import "BRWelcomeETHViewController.h"
#import "BRRootViewController.h"
#import "BRWalletETHManager.h"
#import "BREventManager.h"


@interface BRWelcomeETHViewController ()
...
@implementation BRWelcomeETHViewController
...
//        if (! [BRWalletETHManager sharedInstance].noWallet) { // sanity check
...
{
    NSLog(@"start ETH Wallet");
}

- (IBAction)recover:(id)sender
{
    NSLog(@"recover ETH Wallet");
}

- (IBAction)generate:(id)sender
{
    NSLog(@"generate ETH Wallet");
}

- (IBAction)show:(id)sender
{
    NSLog(@"show ETH Wallet");
}
